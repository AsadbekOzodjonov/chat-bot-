...
function fakeMessage() {
  ...
  $(
    '<div class="message loading new"><figure class="avatar"><img src="1.png" alt="" /></figure><span></span></div>'
  ).appendTo($(".mCSB_container"));
  updateScrollbar();
  ...
  setTimeout(function () {
    ...
    $(
      '<div class="message new"><figure class="avatar"><img src="1.png" alt="" /></figure>' +
        Fake[i] +
        "</div>"
    )
      .appendTo($(".mCSB_container"))
